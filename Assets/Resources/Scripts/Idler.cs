...
public class Idler : Enemy {
    ...
    new void OnCollisionEnter(Collision other) {
        ...
        if (other.gameObject.tag == "Player1") {
            //adds a force to the player in the opposite direction
            other.gameObject.GetComponent<Rigidbody>().AddForce(1000 * (-other.gameObject.GetComponent<Rigidbody>().velocity).normalized);
        }
